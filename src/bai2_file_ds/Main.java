...
public class Main {
    ...
    public static void main(String[] args) {
        String PATH_FILE = "D:\\MD3\\ss17_baithuchanh_file\\src\\bai2_file_ds\\student.txt";
        List<Student> students = new ArrayList<>();
        ...
        writeToObject(PATH_FILE,students);
        List<Student>studentDataFromFile=readDataFromFile("src/bai2_file_ds/student.txt");
